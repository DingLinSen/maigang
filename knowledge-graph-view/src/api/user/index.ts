...
export const getUserListApi = (params: any): Promise<IResponse> => {
  return request.get({ url: '/knowledge-mapping/management/user/list', params })
}
// 获取部门数据列表
...
export const getAllUserListApi = (params: any): Promise<IResponse> => {
  return request.get({ url: '/knowledge-mapping/management/user/userSelect', params })
}

// 获取用户数据列表 项目管理使用
export const userSelectByPmApi = (params: any): Promise<IResponse> => {
  return request.get({ url: '/knowledge-mapping/management/user/userSelectByPm', params })
}

// 获取工号
export const getEenoApi = (): Promise<IResponse> => {
  return request.get({ url: '/knowledge-mapping/management/user/getEeno' })
}

// 新增
export const saveUserApi = (data: Partial<UserData>): Promise<IResponse> => {
  return request.post({ url: '/knowledge-mapping/management/user', data })
}

// 修改
export const editUserApi = (data: Partial<UserData>): Promise<IResponse> => {
  return request.put({ url: '/knowledge-mapping/management/user', data })
}

// 根据id获取用户信息
export const getUserInfoApi = (id: string): Promise<IResponse<UserData>> => {
  return request.get({ url: '/knowledge-mapping/management/user/' + id })
}
// 新增获取岗位和角色
export const getUserSelectApi = (): Promise<IResponse<UserData>> => {
  return request.get({ url: '/knowledge-mapping/management/user/' })
}

// 根据用户id获取分配角色信息
export const getAuthRoleInfoApi = (id: number): Promise<IResponse<UserData>> => {
  return request.get({ url: '/knowledge-mapping/management/user/authRole/' + id })
}
// 根据用户id保存分配角色信息
export const getSubmitAuthRoleInfoApi = (data: Partial<UserData>): Promise<IResponse> => {
  return request.put({
    url: '/knowledge-mapping/management/user/authRole',
    data,
...
export const delUserListApi = (ids: string): Promise<IResponse> => {
  return request.delete({ url: '/knowledge-mapping/management/user/' + ids })
}

// 修改用户状态
export const chageUserStatusApi = (data: Partial<UserData>): Promise<IResponse> => {
  return request.put({ url: '/knowledge-mapping/management/user/changeStatus', data })
}
// 重置密码
export const resetPassWord = (data: Partial<UserData>): Promise<IResponse> => {
  return request.put({ url: '/knowledge-mapping/management/user/resetPwd', data })
}

export const dataScopeApi = (data: Partial<UserData>): Promise<IResponse> => {
  return request.put({ url: '/knowledge-mapping/management/role/dataScope', data })
}

// 获取部门树
export const getUserDeptListApi = (params?: any): Promise<IResponse<DeptTreeData>> => {
  return request.get({ url: '/knowledge-mapping/management/user/deptTree', params })
}

export const exportUserListApi = (data: any) => {
  return download(
    '/knowledge-mapping/management/user/export',
    data,
...
export const uploadAvatarApi = (data: any): Promise<IResponse> => {
  return request.post({
    url: '/knowledge-mapping/management/user/profile/avatar',
    data: data,
...
export const getUserProfileApi = (): Promise<IResponse> => {
  return request.get({ url: '/knowledge-mapping/management/user/profile' })
}

// 修改用户个人信息
export const updateUserProfileApi = (data: any): Promise<IResponse> => {
  return request.put({ url: '/knowledge-mapping/management/user/profile', data: data })
}

export const updateUserPwdApi = (data: any): Promise<IResponse> => {
  return request.put({ url: '/knowledge-mapping/management/user/profile/updatePwd', params: data })
}
