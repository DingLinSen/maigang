...
<template>
  <!-- <div v-show="dailogModel" class="limit-button-class" @click="showLimit">
  ...
  <!-- <div v-if="showModel" class="limit-wrap-class">
    <el-table
      :border="true"
      :data="limitArray"
      class="article-addform-table"
    ...
    >
      <el-table-column label="角色/权限" prop="roleName" width="188">
        <template #default="scope">
          <span class="role-class">{{ scope.row.roleName ? scope.row.roleName : '--' }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="浏览" prop="see" width="56">
        <template #default="scope">
          <div class="cell-class">
            <img v-if="scope.row.see == '1'" class="cell-img" src="@/assets/imgs/home/qx_icon.png"
          /></div>
        </template>
      </el-table-column>
      ...
      >
        <template #default="scope">
          <div class="cell-class">
            <img v-if="scope.row.add == '1'" class="cell-img" src="@/assets/imgs/home/qx_icon.png"
          /></div>
        </template>
      </el-table-column>
      ...
      >
        <template #default="scope">
          <div class="cell-class">
            <img v-if="scope.row.edit == '1'" class="cell-img" src="@/assets/imgs/home/qx_icon.png"
          /></div>
        </template>
      </el-table-column>
...
.limit-button-class:hover {
  .feedback-img-class {
    background: url('@/assets/imgs/home/yjs_icon.png') no-repeat center;
  }
  .limit-img-class {
    background: url('@/assets/imgs/home/qxs_icon.png') no-repeat center;
  }
}
