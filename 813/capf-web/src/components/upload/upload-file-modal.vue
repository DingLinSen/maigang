<template lang="html">
  <div class="upload-container">
    ...
    >
      <div style="padding: 10px 0" class="c-index-base">
...
export default {
  ...
  watch: {
    ...
    uploadURL(){
      this.url = this.uploadURL && this.uploadURL.indexOf('http') === 0 ? this.uploadURL : window.SITE_CONFIG.baseUrl + this.uploadURL
    }
  },
  activated() {
    this.url = this.uploadURL && this.uploadURL.indexOf('http') === 0 ? this.uploadURL : window.SITE_CONFIG.baseUrl + this.uploadURL
