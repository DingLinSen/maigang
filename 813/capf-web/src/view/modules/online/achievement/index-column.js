...
module.exports = function(_this) {
  return {
    ...
    answerNum: {
      ...
      align: 'center',
      render: (h, params) => {
        let value = params.row.answerNum
        if (typeof (value) === 'undefined' || value === null || value === '') {
          value = '--'
        }
        return h('div', [
    ...
    standardRate: {
        ...
        return h(
          'Progress',
          {
            props: {
              ...
              size: 'small',
              percent: parseFloat(
                params.row.standardRate == null ? 0 : params.row.standardRate.toFixed(0)
              )
            }
          },
          params.row.standardRate == null ? '0%' : params.row.standardRate.toFixed(0) + '%'
      ...
      // render: (h, params) => {
      //   let value = params.row.standardRate
      //   if (typeof (value) === 'undefined' || value === null || value === '') {
      //     value = '--'
      //   }
      //   return h('div', [
