  ...
  state: (): AppState => {
    return {
      ...
      theme: wsCache.get('theme') || {
        // 主题色
        elColorPrimary: '#3C9A4C',
        // 左侧菜单边框颜色
        leftMenuBorderColor: 'inherit',
        // 左侧菜单背景颜色
        leftMenuBgColor: '#1E222D',
        // 左侧菜单浅色背景颜色
        leftMenuBgLightColor: '#1E222D',
        // 左侧菜单选中背景颜色
        ...
        // 头部背景颜色
        topHeaderBgColor: '#3C9A4C',
        // 头部字体颜色
        topHeaderTextColor: '#fff',
        // 头部悬停颜色
        topHeaderHoverColor: '#3C9A4C',
        // 头部边框颜色
        topToolBorderColor: '#3C9A4C'
      },
      userNickName: '',
      avatar: ''
    }
