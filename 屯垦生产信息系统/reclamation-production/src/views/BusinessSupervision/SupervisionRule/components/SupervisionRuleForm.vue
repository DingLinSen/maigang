        ...
        >
          <el-row>
            ...
            <el-col :span="4" style="padding: 0px">
              <el-select v-model="topForm.oneCompare" style="width: 100%" :disabled="!isSave">
                <el-option
                  v-for="compareItem in compareList"
            ...
            <el-col :span="6" style="padding: 0px">
              <el-input
                style="width: 100%"
                v-model.trim="topForm.oneNumber"
                :maxlength="50"
                :disabled="!isSave"
              />
            </el-col>
        ...
        <div v-for="(item, index) in configurationList" :key="index" style="width: 100%">
          <Form :model="configurationForm" :isCustom="true" style="width: 100%">
            ...
            <el-row style="width: 100%">
              ...
              <el-col :span="4" style="padding-right: 0px">
                <el-select v-model="item.compare" style="width: 100%" :disabled="!isSave">
                  <el-option
                    v-for="compareItem in compareList"
                    :value="compareItem.value"
                    :key="compareItem.value"
