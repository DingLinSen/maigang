...
const getDetailsData = async () => {
  ...
  params.dictType = param?.dictType || null
  params.dictLabel = param?.dictLabel || null
  params.status = param?.status || null
...
<template>
    ...
    <template #content>
      ...
      >
        <template #operateBtnLeft>
          ...
          <ElButton :loading="delLoading" type="danger" @click="delData(null, true)" plain>
  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" @closed="closeDialog">
