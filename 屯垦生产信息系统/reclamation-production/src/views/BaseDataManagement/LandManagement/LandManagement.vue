...
import LandManagementForm from './components/LandManagementForm.vue'
...
let operationPlanFormRef = ref<ComponentRef<typeof LandManagementForm>>()
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  },
  {
    ...
    formatter: (row: any, __: TableColumn) => {
      return h('span', row.planNumber ? row.planNumber : '')
    }
  },
  {
    field: 'landType',
...
<template>
  <template v-if="!isAdd">
    ...
    <ContentWrap>
      ...
      <LandManagementForm title="土地资源管理" ref="operationPlanFormRef" />
