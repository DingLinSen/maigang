<template>
  <Form ref="formModel" :schema="schema" :rules="rules" label-position="top" hide-required-asterisk size="large"
    class="dark:(border-1 border-[var(--el-border-color)] border-solid) form-content" @register="register">
    <template #title>
