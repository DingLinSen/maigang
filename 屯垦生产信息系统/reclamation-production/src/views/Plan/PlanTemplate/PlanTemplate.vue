...
import { PlanTemplateForm } from './components/index'
...
const PlanTemplateFormRef = ref<ComponentRef<typeof PlanTemplateForm>>()
// useEmitt({
...
const action = (row: any, type: string) => {
  nextTick(() => {
    PlanTemplateFormRef.value?.openDrawer(type, row.id)
  })
}
