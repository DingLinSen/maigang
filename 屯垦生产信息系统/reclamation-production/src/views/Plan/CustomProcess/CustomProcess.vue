...
onMounted(() => {
  ...
  // window.open('https://miyuesc.github.io/process-designer-v2/')
})
// const preWork = () => {
...
//   `)
// }
const url = import.meta.env.VITE_BPMN_URL
</script>

<template>
  <iframe :src="url" class="iframe"></iframe>
  <!-- <div id="container" ref="containerRef">
    <div id="stencil" ref="stencilRef"></div>
    <div id="graph-container" ref="graphContainerRef"></div>
  </div> -->
</template>
<style>
.iframe {
