...
// 岗位下拉选
export const getPostOptionSelectApi = (id?: string): Promise<IResponse<PostData>> => {
...
export const exportPostListApi = (data: any) => {
  return download('/system/management/post/export', data, `post_${new Date().getTime()}.xlsx`)
}
