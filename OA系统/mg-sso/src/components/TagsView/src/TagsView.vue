...
<template>
    <div class="tags-view-cont">
        <div
                ...
                style="top: 10px; box-shadow: 0px 3px 4px 0px rgba(31, 31, 31, 0.2); z-index: 99"
        >
        <span
      ...
      /> -->
      <img style="width: 15px; height: 15px" src="@/assets/imgs/icon/left_icon.png"/>
    </span>
                        ...
                        >
                            <div>
                                <router-link :ref="tagLinksRefs.set" :to="{ ...item }" custom v-slot="{ navigate }">
                                    <div
                                            @click="navigate"
                                            class="h-full flex justify-center items-center whitespace-nowrap pl-30px text-15px"
                                            style="
      ...
      <!-- <Icon
        ...
        :color="appStore.getIsDark ? 'var(--el-text-color-regular)' : '#333'"
      /> -->
      <img style="width: 15px; height: 15px" src="@/assets/imgs/icon/right_icon.png"/>
    </span>
            <span
                    :class="`${prefixCls}__tool`"
                    style="display: flex; text-align: center; justify-content: center; align-items: center"
      ...
      <!-- <Icon
        ...
        :color="appStore.getIsDark ? 'var(--el-text-color-regular)' : '#333'"
      /> -->
      <img style="width: 15px; height: 15px" src="@/assets/imgs/icon/refresh_icon.png"/>
    </span>
            <ContextMenu
                    trigger="click"
                    :schema="[
      ...
      >
        <!-- <Icon
          ...
          :color="appStore.getIsDark ? 'var(--el-text-color-regular)' : '#333'"
        /> -->
        <img style="width: 15px; height: 15px" src="@/assets/imgs/icon/set_icon.png"/>
      </span>
            </ContextMenu>
        </div>
    </div>
