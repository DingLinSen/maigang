...
const uploadFileUrl = ref(PATH_URL + '/file/upload') // 上传文件服务器地址
//请求头
    ...
    <transition-group class="el-upload-list el-upload-list--text" name="el-fade-in-linear" tag="ul">
      <div v-if="fileList.length">
        ...
        >
          ...
          <span style="height: 34px; line-height: 34px; font-size: 14px; color: #444444">
            {{ getFileName(file.url) }}
          </span>
          <!-- 删除按钮 -->
          <div class="ele-upload-list__item-content-action" style="display: inline-flex">
            <img
    ...
    >
      <template #trigger>
        <div class="upload-button-class flex items-center">
          <img src="@/assets/imgs/icon/sc_icon.png" /> <span> 上传附件</span>
        </div>
      </template>
    </ElUpload>
  </div>
