...
export const getDictApi = (): Promise<IResponse> => {
  return request.get({ url: '/system-center/management/dict/type/list' })
}

// 获取某个字典
export const getDictOneApi = async (type): Promise<IResponse> => {
  return request.get({ url: '/system-center/management/dict/data/type/' + type })
}
...
// 获取线路名称
export const getAllLineListApi = (params: any): Promise<IResponse> => {
  return request.get({ url: '/system-center/management/lineInfo/listAll', params })
}
// 根据部门获取线路
export const getLineListByDeptApi = (params: any): Promise<IResponse> => {
  return request.get({ url: '/system-center/management/lineInfo/selectByDeptId', params })
}
// 根据线路获取管界中的行别
export const getLineBussListApi = (params: any): Promise<IResponse> => {
  return request.get({ url: '/system-center/management/lineInfo/selectByLineCode', params })
}

// 根据线路获取行别
export const getLineBussNameListApi = (params: any): Promise<IResponse> => {
  return request.get({
    url: '/system-center/management/lineInfo/selectByLineCode/' + params.lineCode
  })
}
...
// 通用导入方法
export const uploldFile = async (url: string, params: any) => {
...
export const uploadFileApi = async (params: any) => {
  return uploldFile('/file/upload', params)
}
