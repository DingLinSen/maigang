...
import pic1 from '@/assets/imgs/nav_pic1.png'
import pic2 from '@/assets/imgs/nav_pic2.png'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const renderMenu = () => {
      return (
        <div class={[{ 'over-collapse': !collapse.value }, 'menu-boyder-new']}>
          <ElMenu
            class="menu-wrap"
          ...
          {!unref(collapse) ? (
            <div class="menu-footer 2xl:bottom-20px bottom-10px">
              <img src={pic1} class="img-core-value" />
              {/* <div class="footer-content core-values 2xl:w-200px 2xl:h-72px w-156px h-56px"></div> */}
              <img src={pic2} class="img-high-grow" onClick={openHighGrowth} />
              {/* <div
