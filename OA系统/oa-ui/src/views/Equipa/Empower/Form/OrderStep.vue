    ...
    <div class="table-row w-full h-full">
      <div class="right-left-class">
        ...
        >
          ...
          <img
            ...
            class="right-icon-apply-class"
            v-show="!item.orderStep || item.orderStep === '提出申请'"
          />
          <img
            src="@/assets/imgs/order/file_icon.png"
            class="right-icon-apply-class"
            v-show="item.orderStep === '证书生成'"
          />
        </div>
        <img
        ...
        <img
          ...
          class="right-icon-status-class"
          v-show="item.orderStep === '待审核'"
        />
        <img
          src="@/assets/imgs/order/reject_icon.png"
          class="right-icon-status-class"
          v-show="item.orderStep === '已驳回'"
        />
      ...
      <div class="right-apply-info-class">
        <span
          ...
          :title="getRoleName(item.postName) + '：' + item.createByName"
          >{{ getRoleName(item.postName) + '：' + item.createByName }}</span
        >
        ...
        <div>
          <span
            ...
            >{{ item.orderStep ? item.orderStep : '提出申请' }}</span
          ></div
        >
        <div v-if="item.orderExpain" class="right-reason-class">{{ item.orderExpain }}</div>
