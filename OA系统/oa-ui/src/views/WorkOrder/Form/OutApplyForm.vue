...
const rules = reactive({
  applyType: [{ required: true, message: '请选择外出类型', trigger: 'change' }],
  startEndDate: [
...
//添加知会人
const selectType = ref<number>(0) //0代表添加外出人员 1代表添加知会人
...
<template>
  ...
  >
    ...
    >
      <el-row>
        <el-col :span="24">
          <el-form-item label="外出类型" prop="applyType">
            <el-select
              placeholder="请选择外出类型"
              style="width: 100%"
              :clearable="true"
        ...
        <el-col :span="12">
          <el-form-item label="外出时长" prop="sumDate">
            <el-input
              type="text"
        ...
        <el-col :span="24">
          <el-form-item label="外出事由" prop="applyReason">
            <el-input
              type="textarea"
