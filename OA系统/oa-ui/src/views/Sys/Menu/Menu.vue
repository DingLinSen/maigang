...
<template>
  <ContentWrap Showtitle="菜单管理">
    <template #ContentWrapTitle>
      <div>
        <ElButton class='btn-add' @click='AddAction()' plain v-hasPermi="'system:menu:add'">
          <template #icon>
        ...
        >
        <ElButton class='exportBtn' @click='toggleRowExpansion' plain>
          <template #icon>
