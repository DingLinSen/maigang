<template>
  ...
  >
    <Form :schema="schema" ref="formRef">
      ...
      <!-- 富文本 -->
      <!--      <template #content>-->
      <!--        <Editor v-model='content' ref='editorRef' :height='200' />-->
      <!--      </template>-->
    </Form>
    <template #footer>
      <div class="footer">
        ...
        <el-button
          v-if="isAuth('AdministrativeService:systemManagement:submit')"
          type="primary"
          :loading="loading"
          @click="save(0)"
        >
        ...
        <el-button
          v-if="isAuth('AdministrativeService:systemManagement:publishing')"
          type="success"
          @click="save(1)"
          >一键发布
        </el-button>
