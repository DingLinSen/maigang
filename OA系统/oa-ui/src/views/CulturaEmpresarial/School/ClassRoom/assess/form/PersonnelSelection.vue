...
const userListAllData = ref()
const userDeptListData = ref()
...
const openDialog = (selectUser: any[], allUserData: any[], deptArray: any[]) => {
  ...
  userListAllData.value = allUserData
  userDeptListData.value = deptArray
  userData.value = selectUser
  deptClick(deptArray[0], 0)
