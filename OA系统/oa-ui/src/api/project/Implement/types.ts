...
export type ImplementData = {
  ...
  predictContractMoney: string // 预计合同金额
  ...
  principalPerson: number | string
  principalPersonName: string // 主要负责人
  upPrincipalName: string // 主要负责人
...
export type ImplementCount = {
  lxzt: number | null // 培育总项目
  count: number | null // 培育审批中
  jszz: number | null // 结束终止
  jzz: number | null // 进展中
}
